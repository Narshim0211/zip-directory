  ...
  return (
    <Layout>
      <NewsletterComposer
        audience="OWNER"
        audienceLabel="Owner"
        audienceDescription="Create and send business growth strategies, marketing insights, and platform updates to your owner subscribers."
        onSave={handleSave}
...
export default OwnerNewsletter;
